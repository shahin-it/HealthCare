...
<div class="card skui-tabular-content patient" id="patient-tab">
    <div class="card-header panel-header">
        <h5 class="panel-title">Manage Patients</h5>
            ...
            <g:each in="${items}" var="patient">
                <tr class="odd gradeX">
                    ...
                    <td class="action-navigator btn-group center" data-id="${patient.id}">
                        ...
                        <span class="btn btn-sm btn-warning remove" title="Remove"><i class="fas fa-trash-alt"></i>
                        </span>
                    </td>
                </tr>
            </g:each>
