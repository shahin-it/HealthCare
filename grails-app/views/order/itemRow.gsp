<tr class="order-item">
    ...
    <td class="quantity"><span class="value"><input name="${item.id}.quantity" type="number" required value="${item.quantity}" min="1"></span></td>
    <td class="rate"><span class="value"><input name="${item.id}.basePrice" type="number" required value="${item.basePrice}" min="0"></span></td>
    <td class="discount"><span class="value"><input name="${item.id}.discount" type="number" required value="${item.discount}" min="0"></span></td>
